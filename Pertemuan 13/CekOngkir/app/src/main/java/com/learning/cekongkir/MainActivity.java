package com.learning.cekongkir;
...
import com.learning.cekongkir.adapter.CityAdapter;
import com.learning.cekongkir.adapter.ExpedisiAdapter;
import com.learning.cekongkir.adapter.ProvinceAdapter;
import com.learning.cekongkir.api.ApiService;
import com.learning.cekongkir.api.ApiUrl;
import com.learning.cekongkir.model.city.ItemCity;
import com.learning.cekongkir.model.cost.ItemCost;
import com.learning.cekongkir.model.expedisi.ItemExpedisi;
import com.learning.cekongkir.model.province.ItemProvince;
import com.learning.cekongkir.model.province.Result;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<com.learning.cekongkir.model.city.Result> ListCity = new ArrayList<com.learning.cekongkir.model.city.Result>();
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = mListView.getItemAtPosition(i);
                com.learning.cekongkir.model.city.Result cn = (com.learning.cekongkir.model.city.Result) o;
        ...
        call.enqueue(new Callback<ItemCity>() {
            ...
            public void onResponse(Call<ItemCity> call, Response<ItemCity> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    int count_data = response.body().getRajaongkir().getResults().size();
                    for (int a = 0; a <= count_data - 1; a++) {
                        com.learning.cekongkir.model.city.Result itemProvince = new com.learning.cekongkir.model.city.Result(
    ...
    public void getCoast(String origin,
        ...
        Call<ItemCost> call = service.getCost(
                " bd3ba6866beef9568c59b088cf4db159",
                origin,
                destination,
                weight,
                courier
